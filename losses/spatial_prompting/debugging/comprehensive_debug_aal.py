...
def check_sample_masks(num_samples=10):
    ...
    masks_dir = Path("/Disk1/afrouz/Data/TextBraTS_atlas_masks_aal_v2")
...
def visualize_masks_vs_gt(num_samples=15):
    ...
    data_dir = Path("/Disk1/afrouz/Data/Merged")
    masks_dir = Path("/Disk1/afrouz/Data/TextBraTS_atlas_masks_aal_v2")
    output_pdf = Path("/Disk1/afrouz/Projects/TextBraTS/losses/spatial_prompting/debugging/atlas_vs_gt_visualization_v2.pdf")
